...
W1 = rand(hidden1_node,input_node)* 10;
W2 = rand(output_node,hidden1_node+1)* 10;
...
for j=1:1000
	...
	for i=1:m
		...
		delta3 = (a3 - Y(i,:)');
		delta2 = (W2(:,2:6)' * delta3) .* (a2(2:6) .* (1 - a2(2:6)));
	...
	W1_velocity = W1_velocity * momentum - (0.001).* Delta1;
	W2_velocity = W2_velocity * momentum - (0.001) .* Delta2;
	W1 = W1  + W1_velocity;
	W2 = W2  + W2_velocity;
end
